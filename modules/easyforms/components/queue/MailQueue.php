...
namespace app\modules\easyforms\components\queue;

use Yii;
use Exception;
use yii\db\Expression;
use yii\swiftmailer\Mailer;
use app\modules\easyforms\models\Queue;
...
class MailQueue extends Mailer
{
     ...
     */
    public $messageClass = 'app\modules\easyforms\components\queue\Message';
