...
?>
    <div class="container app-restricted" style="padding-top: 10px; padding-bottom: 10px">
        <div class="row">
            <div class="col-xs-12">
                <h3 class="legend text-danger"><?= Yii::t('form', 'Access to this form is restricted.') ?></h3>
                ...
                <?= $form->field($model, 'password', [
                    'inputOptions' => [
                        'class' => 'form-control',
                        'placeholder' => Yii::t('form', 'Please enter your password.')
                    ]
                ])->passwordInput()->label(Yii::t('form', 'Password')) ?>
                <?= Button::widget([
