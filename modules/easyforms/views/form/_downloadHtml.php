    ...
    <div class="panel-body">
        <div class="checkbox" style="margin-top: 0">
            <label class="checkbox-inline">
                ...
                <small><?= Yii::t('form', 'Only HTML & CSS code.') ?> <span
                            class="text-muted"><?= Yii::t("app", "Conditional rules, multi-steps, form tracking, and other javascript tools will NOT work with this code.") ?></span>
                </small>
            </label>
        </div>
        <?= Html::a(Yii::t('form', 'Download'),
...
<div class="panel panel-info">
    <div class="panel-heading">
        <h3 class="panel-title"><?= Yii::t("app", "Form Endpoint: Collect data with external form") ?></h3>
    </div>
    <div class="panel-body">
        ...
        <form id="formEndpoint">
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    <input type="submit" class="btn btn-info" value="<?= Yii::t('form', 'Copy') ?>">
                </span>
            </div><!-- /input-group -->
        </form>
    </div>
