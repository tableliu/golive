...
$this->params['breadcrumbs'][] = Yii::t('form', 'Embed or Share');
        ...
        <div class="row">
            <div class="col-sm-3">
                ...
                echo SideNav::widget([
                    ...
                    'heading' => '<i class="glyphicon glyphicon-share-alt"></i> ' . Yii::t('form', 'Embed or Share'),
            ...
            <div class="col-sm-9">
                ...
                <div class="panel panel-default" id="popUp" style="display: none">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="glyphicon glyphicon-more-windows"
                    ...
                    <div class="panel-body">
                        ...
                        <p style="margin-bottom: 25px">
                            <strong><?= Yii::t('form', 'Fully customizable options like colors, borders, radius, backgrounds, button placements and many more options to make it look awesome in any web page.') ?></strong>
                        </p>
                ...
                <div class="panel panel-default" id="link" style="display: none">
                    ...
                    <div class="panel-body">
                        ...
                        <p>
                            <strong><?= Yii::t("app", "Sharing has never been easier just copy the direct link below.") ?>
                            </strong></p>
                ...
                <div class="panel panel-default" id="download" style="display: none">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="glyphicon glyphicon-cloud-download"
                                                   style="margin-right: 5px;"></i>
                    ...
                    <div class="panel-body">
                        ...
                        <p>
                            <strong><?= Yii::t("app", "Great for designers who want to change the markup or developers who want to collect data with mobile apps.") ?></strong>
                        </p>
