...
use Carbon\Carbon;
use app\modules\easyforms\bundles\WysiwygBundle;
...
$this->params['breadcrumbs'][] = Yii::t('form', 'Settings');
...
$adminEmail = Yii::$app->formsettings->get("app.adminEmail");
$supportEmail = Yii::$app->formsettings->get("app.supportEmail");
$noreplyEmail = Yii::$app->formsettings->get("app.noreplyEmail");
...
$emailFields = array(
    Yii::t('form', 'Email Fields') => $emailLabels,
);
...
<div class="form-config-page">
    ...
    <div class="page-header">
        <h1><?= Html::encode($this->title) ?>
            <small><?= Yii::t('form', 'Settings') ?></small>
        </h1>
    </div>
            ...
            <div class="tab-content">
                    ...
                    <?php echo FormGrid::widget([
                        ...
                        'rows' => [
                            ...
                            [
                                ...
                                'attributes' => [
                                    ...
                                    'language' => [
                                        ...
                                        'options' => [
                                            'data' => \app\modules\easyforms\helpers\Language::supportedLanguages()
                                        ],
                            ...
                            [
                                'contentBefore' => Html::tag(
                                    'legend',
                                    Yii::t('form', 'Submission Settings'),
                                    ['class' => 'text-primary']
                                ),
                                'columns' => 12,
                                'autoGenerateColumns' => false, // override columns setting
                            ...
                            [
                                'contentBefore' => Html::tag(
                                    'legend',
                                    Yii::t('form', 'Form Activity & Limits'),
                                    ['class' => 'text-primary']
                                ),
                                'columns' => 12,
                                'autoGenerateColumns' => false, // override columns setting
                                'attributes' => [
                                    'total_limit' => [
                                        ...
                                        'value' => $form->field($formModel, 'total_limit')->radioButtonGroup(
                                            [
                                                $formModel::ON => Yii::t('form', 'Yes'),
                                                $formModel::OFF => Yii::t('form', 'No'),
                                            ],
                                            [
                                ...
                                'attributes' => [
                                    ...
                                    'total_limit_period' => [
                                        ...
                                        'options' => [
                                            ...
                                            'pluginOptions' => [
                                                'placeholder' => Yii::t('form', 'Select time period'),
                                                'allowClear' => true
                                            ],
                                        ],
                                        'columnOptions' => ['colspan' => 3],
                    ...
                    <?php echo FormGrid::widget([
                        ...
                        'rows' => [
                            [
                                'contentBefore' => Html::tag(
                                    'legend',
                                    Yii::t('form', 'Confirmation Settings'),
                                    ['class' => 'text-primary']
                                ),
                                'attributes' => [
                                    'type' => [
                                ...
                                'attributes' => [
                                    'send_email' => [
                                        ...
                                        'value' => $form->field($formConfirmationModel, 'send_email')->radioButtonGroup(
                                            [
                                                $formConfirmationModel::CONFIRM_BY_EMAIL_ENABLE => Yii::t('form', 'Yes'),
                                                $formConfirmationModel::CONFIRM_BY_EMAIL_DISABLE => Yii::t('form', 'No'),
                                            ],
                                            [
                                                'itemOptions' => ['labelOptions' => ['class' => 'btn btn-primary']],
                                                'style' => 'display:block; margin-bottom:15px; overflow:hidden',
                    ...
                    <?php echo FormGrid::widget([
                        ...
                        'rows' => [
                            [
                                'contentBefore' => Html::tag(
                                    'legend',
                                    Yii::t('form', 'Email Notification Settings'),
                                    ['class' => 'text-primary']
                                ),
                                'attributes' => [
                                    'subject' => [
                ...
                <div role="tabpanel" class="tab-pane fade" id="form_theme_settings">
                    <?php echo FormGrid::widget([
                        ...
                        'rows' => [[
                            'contentBefore' =>
                                Html::tag('legend', Yii::t('form', 'UI Settings'), ['class' => 'text-primary']),
                            'attributes' => [
                                'js_file' => [
                                    'type' => Form::INPUT_TEXT,
                                    'hint' => Yii::t(
                            ...
                            [
                                'attributes' => [
                                    'theme_id' => [
                                        'type' => Form::INPUT_WIDGET,
                                        'widgetClass' => '\kartik\select2\Select2',
                                        'label' => Yii::t('form', 'Select a Theme'),
                                        'hint' => Yii::t("app", "Select the theme that fits best to your form."),
                                        'options' => [
                                            'data' => $themes,
                                            'pluginOptions' => [
                                                'placeholder' => Yii::t('form', 'Select a Theme'),
                                                'allowClear' => true
                                            ],
                                            'pluginEvents' => [
                ...
                <div class="form-group" style="text-align: right; margin-top: 30px">
                    <?= Html::submitButton(Yii::t('form', 'Save and continue'), ['name' => 'continue', 'class' => 'btn btn-default', 'style' => 'margin-right: 5px']) ?>
                    <?= Html::submitButton('<span class="glyphicon glyphicon-ok"></span> ' . Yii::t('form', 'Save'), ['class' => 'btn btn-primary']) ?>
                </div>
            </div>
        </div>
        <?php ActiveForm::end(); ?>
