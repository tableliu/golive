...
use app\modules\easyforms\bundles\SubmissionsBundle;
...
$options = array(
    ...
    'settings' => Yii::$app->formuser->preferences->get('GridView.submissions.settings.' . $formModel->id), // User Preference
    ...
    'i18n' => [
        ...
        'submissionDetails' => Yii::t('form', 'Submission Details'),
        'addSubmission' => Yii::t('form', 'Add Submission'),
        'editSubmission' => Yii::t('form', 'Edit Submission'),
        'bulkActions' => Yii::t('form', 'Bulk Actions'),
        'uploadingFile' => Yii::t('form', 'You have files upload pending! Files will be lost!'),
        'errorOnUpdate' => Yii::t('form', 'Sorry, the items haven\'t been updated.'),
        'errorOnDelete' => Yii::t('form', 'Sorry, the items haven\'t been deleted.'),
        'areYouSureDeleteCommentItem' => Yii::t('form', 'Are you sure you want to delete this comment? All data related to this item will be deleted. This action cannot be undone.'),
        'areYouSureDeleteFileItem' => Yii::t('form', 'Are you sure you want to delete this file? All data related to this item will be deleted. This action cannot be undone.'),
        'areYouSureDeleteItem' => Yii::t('form', 'Are you sure you want to delete this submission? All data related to this item will be deleted. This action cannot be undone.'),
        'areYouSureDeleteItems' => Yii::t('form', 'Are you sure you want to delete these submissions? All data related to each item will be deleted. This action cannot be undone.'),
        'today' => Yii::t('form', 'Today'),
        'yesterday' => Yii::t('form', 'Yesterday'),
        'last7Days' => Yii::t('form', 'Last 7 Days'),
        'last30Days' => Yii::t('form', 'Last 30 Days'),
        'thisMonth' => Yii::t('form', 'This Month'),
        'lastMonth' => Yii::t('form', 'Last Month'),
        'customRange' => Yii::t('form', 'Custom Range'),
        'apply' => Yii::t('form', 'Apply'),
        'clear' => Yii::t('form', 'Clear'),
    ]
);
...
<div class="submissions-page">
    ...
    <script type="text/template" id="navTemplate">
        <ul class="breadcrumb breadcrumb-arrow hidden-print">
            <li><?= Html::a(Yii::t('form', 'Dashboard'), ['/dashboard']) ?></li>
            <li><?= Html::a(Yii::t('form', 'Forms'), ['/form']) ?></li>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="summary">
                        ...
                        ]) ?> {{ if( totalCount > 1 ) { }} <?= Yii::t('form', 'items') ?>
                        {{ } else { }}
                        <?= Yii::t('form', 'item') ?>{{ } }}.
                    ...
                    <h3 class="panel-title">
                        ...
                        <small class="panel-subtitle hidden-xs"><?= Yii::t("app", "Submissions") ?></small>
                    </h3>
                </div>
                            ...
                            <div class="col-md-5">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-btn">
                                        <?= Html::a(
                                            '<span class="glyphicon glyphicon-filter"></span> ' . Yii::t('form', 'Filter'),
                                            ['#'],
                                            ['id' => 'filter-link', 'class' => 'btn btn-primary', 'style' => 'margin-bottom:10px', 'data-start' => '', 'data-end' => '']) ?>
                                        <!-- Single button -->
                                        <button type="button" class="btn btn-primary dropdown-toggle"
                                                style="margin-bottom:10px" data-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false"><span
                                                    class="glyphicon glyphicon-download-alt"></span> <?= Yii::t('form', 'Export') ?>
                                            <span class="caret"></span></button>
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><?= Html::a(
                                                    Yii::t('form', 'Export as CSV'),
                                                    ['form/export-submissions', 'id' => $formModel->id, 'format' => 'csv'],
                                                    ['id' => 'csv-link']) ?></li>
                                            <li><?= Html::a(
                                                    Yii::t('form', 'Export as MS Excel'),
                    ...
                    <table class="table table-striped table-hover table-list">
                        ...
                        <tr>
                            <td colspan="<?= $totalFields + 3 ?>">
                                <div class="empty">
                                    <?= Yii::t('form', 'No results found.') ?></div>
                            </td>
                        </tr>
                        {{ } }}
                        </tbody>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">{{- form_name }}
                        <small class="panel-subtitle hidden-xs">{{= subtitle }}</small>
                    </h3>
    ...
    <script type="text/template" id="detailTemplate">
        <div class="grid-view">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="pull-right">
                        <div class="summary hidden-xs"><?= Yii::t('form', 'Showing 1 item.') ?></div>
                    </div>
                    <h3 class="panel-title">{{= form_name }}
                        <small class="panel-subtitle hidden-xs">
                            <?= Yii::t("app", "Submission Details") ?></small>
                    </h3>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="row" style="padding: 0 20px">
                        ...
                        <table class="table table-bordered table-striped table-detail">
                            ...
                            <tr class="info">
                                <th colspan="2">
                                    ...
                                    <div class="pull-right emptyFields" style="font-weight: normal; font-size: 70%">
                                        <input type="checkbox" id="showEmptyFields"
                                               style="vertical-align: middle; margin: 0" {{=showEmptyFields }}/>
                                        <label for="showEmptyFields" class="checkbox-inline"
                                               style="font-size: 12px; margin: 0; padding: 0;">
                                            <?= Yii::t('form', 'Empty Fields') ?>
                                        </label>
                                    </div>
                                </th>
                            </tr>
                                ...
                                <tr data-file="{{= file.id }}">
                                    ...
                                    <td>
                                        <a target="_blank" href="{{= file.link }}"
                                           title="<?= Yii::t("app", "Download File") ?>">{{= file.originalName }}</a>
                                        ({{= file.extension }}, {{= file.sizeWithUnit }}) <a class="removeFile"
                    ...
                    <div class="col-sm-4">
                        <div class="commentBox">
                            <div class="titleBox"><?= Yii::t('form', 'Comments') ?></div>
                            <div class="actionBox">
                                <ul id="commentList" class="commentList">
                                    {{ _.each(comments, function(comment, i) { }}
                                    <li class="comment{{ if(i%2) { }} alt{{ } }}" data-comment-id="{{= comment.id }}">
                                        <div class="commentText">
                                            <p><span class="author">{{= comment.authorName }}</span> - <span
                                                        class="date sub-text">{{= comment.submitted }}</span> <a
                                                        href="#" class="deleteComment" data-id="{{= comment.id }}"
                                                        title="<?= Yii::t('form', 'Delete Comment') ?>"><span
                                ...
                                <form role="form" class="clearfix">
                                    <div class="form-group">
                                        <textarea id="commentContent" class="form-control"
                                                  placeholder="<?= Yii::t('form', 'Your comments') ?>"></textarea>
                                    </div>
                                    <div class="">
                                        <button id="addComment" class="btn btn-success"><span
                                                    class="glyphicon glyphicon-ok"></span> <?= Yii::t('form', 'Save Comment') ?>
                                        </button>
                                    </div>
                                </form>
                            </div>
        ...
        <div>
            ...
            <ul class="pagination">
                <li {{ if( currentPage== 1 ) { }} class="disabled" {{ } }}>
                    <a href="#" aria-label="<?= Yii::t("app", "First") ?>"
                       class="first"><?= Yii::t("app", "First") ?></a>
                </li>
