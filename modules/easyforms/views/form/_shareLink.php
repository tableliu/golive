        ...
        <form id="showForm">
            <div class="checkbox">
                <label class="checkbox-inline">
                    <input type="checkbox" id="withoutDesign">
                    <small><?= Yii::t('form', 'Without design') ?></small>
                </label>
                <label class="checkbox-inline">
                    <input type="checkbox" id="withoutBox">
                    <small><?= Yii::t('form', 'Without box') ?></small>
                </label>
                <label class="checkbox-inline">
                    <input type="checkbox" id="withoutCustomJS">
                    <small><?= Yii::t('form', 'Without custom JS') ?></small>
                </label>
            </div>
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    <input type="submit" class="btn btn-info" value="<?= Yii::t('form', 'Go!') ?>">
                </span>
            </div><!-- /input-group -->
        </form>
    </div>
...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        ...
        <form id="showFormAlt">
            <div class="checkbox">
                <label class="checkbox-inline">
                    <input type="checkbox" id="withoutBoxAlt">
                    <small><?= Yii::t('form', 'Without box') ?></small>
                </label>
            </div>
            <div class="input-group">
