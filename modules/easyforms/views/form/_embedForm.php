...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        <p><strong>
                <?= Yii::t('form', 'Love the theme you have created? Well, now you can share it with all.') ?>
            </strong></p>
        <p><?= Yii::t(
                'app',
        ...
        <form>
        <textarea class="form-control" rows="3" onfocus="this.select();" onmouseup="return false;"><!-- Easy Forms -->
...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        <p><strong><?= Yii::t('form', 'Maybe this time you want to share without your theme?') ?></strong></p>
        <p><?= Yii::t('form', 'To place your form without the theme design on your website just copy and paste the following embed code.') ?></p>
        <form>
        <textarea class="form-control" rows="3" onfocus="this.select();" onmouseup="return false;"><!-- Easy Forms -->
<div id="c<?= $formModel->id ?>">
    <?= Yii::t('form', 'Fill out my') ?> <a
