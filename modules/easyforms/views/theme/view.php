...
$this->params['breadcrumbs'][] = ['label' => Yii::t('form', 'Themes'), 'url' => ['index']];
...
<div class="theme-view box box-big box-light">
    ...
    <div class="pull-right" style="margin-top: -5px">
        <?= Html::a('<span class="glyphicon glyphicon-pencil"></span> ', ['update', 'id' => $themeModel->id], [
            'title' => Yii::t('form', 'Update Theme'),
            'class' => 'btn btn-sm btn-info']) ?>
        <?= Html::a('<span class="glyphicon glyphicon-bin"></span> ', ['delete', 'id' => $themeModel->id], [
            'title' => Yii::t('form', 'Delete Theme'),
            'class' => 'btn btn-sm btn-danger',
            'data' => [
                'confirm' => Yii::t('form', 'Are you sure you want to delete this theme? All data related to this item will be deleted. This action cannot be undone.'),
                'method' => 'post',
            ],
        ]) ?>
    </div>
    ...
    <div class="box-header">
        <h3 class="box-title"><?= Yii::t('form', 'Theme') ?>
