...
class FormDOM
{
    ...
    public function loadFields($tagNames = '*')
    {
        ...
        foreach (iterator_to_array($this->dom->getElementsByTagName("script")) as $node) {
            throw new \Exception(Yii::t('form', 'Your form should not contain "script" tags.'));
        };
        ...
        foreach ($onAttributes as $onAttribute) {
            throw new \Exception(Yii::t('form', 'Your form should not contain HTML Event Attributes.'));
        }
    ...
    public function getFormTitle()
    {
        ...
        return isset($heading->nodeValue) ? $heading->nodeValue : Yii::t('form', 'Untitled Form');
    }
