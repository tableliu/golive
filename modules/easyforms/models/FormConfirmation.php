...
class FormConfirmation extends ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'type' => Yii::t('form', 'Confirms that the submission was successful with:'),
            'message' => Yii::t('form', 'Your Message'),
            'url' => Yii::t('form', 'Page URL'),
            'send_email' => Yii::t('form', 'Send a Confirmation Email?'),
            'mail_to' => Yii::t('form', 'Send To'),
            'mail_from' => Yii::t('form', 'Reply To'),
            'mail_subject' => Yii::t('form', 'Subject'),
            'mail_message' => Yii::t('form', 'E-Mail Message'),
            'mail_receipt_copy' => Yii::t('form', "Includes a Submission Copy"),
            'mail_from_name' => Yii::t('form', 'Name or Company'),
