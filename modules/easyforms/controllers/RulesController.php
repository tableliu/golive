...
{
    public $modelClass = 'app\modules\easyforms\models\FormRule';
    public $defaultRoute = '';
    public $serializer = [
...
//        if (!empty(Yii::$app->user) && Yii::$app->user->isGuest || !Yii::$app->formuser->canAccessToForm($id)) {
