...
use app\modules\easyforms\models\FormSubmissionComment;
...
{
    public $modelClass = 'app\modules\easyforms\models\FormSubmission';
    ...
    public function actions()
    {
        ...
        $actions['index']['prepareDataProvider'] = function () {
            ...
            return new ActiveDataProvider([
                'query' => $query,
                'pagination' => [
                    'pageSize' => Yii::$app->formuser->preferences->get('GridView.pagination.pageSize'),
                ],
                'sort' => [
    ...
    public function actionUpload($id, $s_id)
    {
        ...
        foreach ($_FILES as $fieldID => $file) {
            if ($fileModel = FormSubmissionFile::findOne(['submission_id' => $s_id, 'field' => $fieldID])) { // Update File if exists
                ...
                $fileFields = $formData->getFileLabels();
