...
(function ($) {
    ...
    ConditionsBuilder.prototype = {
        ...
        buildConditional: function (ruleData) {
            ...
            var addRuleLink = $("<a>", {
                "href": "#",
                "class": "add-rule btn btn-warning btn-xs",
                "text": options.i18n.addCondition
            });
            ...
            var addConditionLink = $("<a>", {
                "href": "#",
                "class": "add-condition btn btn-warning btn-xs",
                "text": options.i18n.addGroup
            });
            ...
            var removeLink = $("<a>", {
                "class": "remove btn btn-danger btn-xs",
                "href": "#",
                "text": options.i18n.deleteText
            });
