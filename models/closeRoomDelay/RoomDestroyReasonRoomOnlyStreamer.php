...
class RoomDestroyReasonRoomOnlyStreamer implements InterfaceCloseRoomDelay
{
    /**
     * @param $room_id
     * @param $reason
    ...
    public function closeRoomDelay($room_id, $reason, $delay_sec, $pid)
    {
        Yii::$app->queueCloseRoomDelay
            ->delay($delay_sec)
            ->push(new LiveRoomCloseOnlyStreamer(['room_id' => $room_id, 'reason' => $reason, 'project_id' => $pid]));
