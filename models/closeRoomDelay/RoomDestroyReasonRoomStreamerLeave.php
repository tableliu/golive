...
class RoomDestroyReasonRoomStreamerLeave implements InterfaceCloseRoomDelay
{
    ...
    public function closeRoomDelay($room_id, $reason, $delay_sec, $pid)
    {
        Yii::$app->queueCloseRoomDelay
            ->delay($delay_sec)
            ->push(new LiveRoomCloseAfterStreamerLeave(['room_id' => $room_id, 'reason' => $reason, 'project_id' => $pid]));
